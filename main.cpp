...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Wagerr-seeder\n"
...
static const string mainnet_seeds[] = {"main.seederv1.wgr.host", "main.seederv2.wgr.host", ""};
static const string testnet_seeds[] = {"test.seederv1.wgr.host",
                                       "test.seederv2.wgr.host",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("xxxxxxxxxxxxxxxx.onion", 55002), true);
  }
  do {
